...
"""
# StaffMixin is used in order to permit access the function for staff
# users only
...
def cerca(request):
    if "q" in request.GET:
       ...
       # icontains checks that the value associated to the querystring is
       # conteined in title, content and username
